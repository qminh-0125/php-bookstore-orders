...
<div class="form-container">
    <h2>Chỉnh sửa Khách hàng tiềm năng</h2>
    <p class="form-subtitle">Cập nhật thông tin khách hàng tiềm năng mua sách (ID: #<?= e($id) ?>).</p>

    <form method="post" action="/book-leads/update" class="form-card">
        <!-- Hidden ID -->
        ...
        <div class="form-group">
            ...
            <textarea id="note" name="note" rows="4" placeholder="Nhập ghi chú hoặc nhu cầu tìm sách"><?= e($old['note'] ?? '') ?></textarea>
        </div>

        <!-- Nút thao tác -->
        <div class="form-actions">
            <button type="submit" class="btn primary">Cập nhật thông tin</button>
            <a href="/book-leads" class="btn secondary">Hủy bộ</a>
        </div>
    </form>
</div>
...
$title = 'Sửa Khách hàng - Bookstore App';
